...
"@ | Out-File -Encoding utf8 -FilePath "src/services/firebaseClient.js"
...
"@ | Out-File -Encoding utf8 -FilePath "src/context/AuthContext.js"
...
"@ | Out-File -Encoding utf8 -FilePath "src/context/ThemeContext.js"
...
"@ | Out-File -Encoding utf8 -FilePath "src/navigation/RouteGuards.js"
...
"@ | Out-File -Encoding utf8 -FilePath "src/navigation/AppNavigator.js"
...
$stubs.GetEnumerator() | ForEach-Object { $_.Value | Out-File -Encoding utf8 -FilePath $_.Key }
...
"@ | Out-File -Encoding utf8 -FilePath "App.js"
...
"@ | Out-File -Encoding utf8 -FilePath "babel.config.js"
...
"@ | Out-File -Encoding utf8 -FilePath "metro.config.js"
